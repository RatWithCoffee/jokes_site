Сайт с анекдотами для универа. У пользователя есть возможность добавлять анекдоты, в админ панели админ может добавить или удалить анекдот предложенный пользователем.
